# Wallapop Estafa - Reporte de Abusos y Malas Prácticas

Este repositorio contiene el código fuente de la web [¿Es Wallapop una Estafa?](https://wallapop-estafa.github.io) (o el dominio que se asigne), un espacio dedicado a documentar, analizar y exponer las malas prácticas, estafas y fallos sistémicos en la plataforma de compraventa Wallapop, especialmente en su sistema de Wallapop Envíos y su seguro de protección.
...
Si quieres que tu caso aparezca en la web o simplemente quieres dejar constancia técnica del abuso, abre una **[Issue](https://github.com/alexdc/Wallapop-estafa/issues/new/choose)** usando la plantilla de "Reporte de Abuso".
